...
class TrainModel(object):
    ...
    def __init__(self, filename):
        ...
        df_features, df_labels = self.df, self.df.pop("walltime_failure")
        ...
        ################################################
        print(original_num_of_cols, df.shape[0], df.shape[1])
        # test_size = 0.2
...
toolids=["devteam_fastq_paired_end_splitter_fastq_paired_end_splitter_1.0.0"]
